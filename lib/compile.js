...
/**
 * Default blacklist of commonly used passwords.
 * @type {Set<string>}
 */
...
/**
 * Deeply clones a value (objects and arrays only).
 *
...
/**
 * Compiles a validation schema into an async validator function.
 *
 * @param {Object} schema - Validation schema definition.
 * @param {Object} [options]
 * @param {boolean} [options.nestedStrict=false] - Enforce strict mode on nested objects.
 *
 * @returns {(
 *   obj: Object,
 *   path?: string
 * ) => Promise<Object>} Async validation function.
 *
 * @throws {Error} Throws an error with `error.errors` array if validation fails.
 */
export function compile(schema, { nestedStrict = false } = {}) {
  ...
  for (const key of Object.keys(schema)) {
    ...
    /**
     * Nested object validator (if applicable)
     * @type {Function|null}
     */
    ...
    /**
     * Array item validator (if applicable)
     * @type {Function|null}
     */
     ...
     * @param {Array<Object>} errors - Error accumulator.
     */
  ...
  /**
   * Executes validation against an object.
   *
   * @param {Object} obj - Object to validate.
   * @param {string} [path=""] - Internal path (used for nesting).
   * @returns {Promise<Object>} Validated (and possibly transformed) object.
   * @throws {Error} If validation fails (error.errors contains details).
   */
...
/**
 * Builds a value-level validator used for validating array items.
 *
 * @param {Object} fieldSchema - Schema definition for a single value.
 * @returns {(value: any, path: string) => Promise<any>}
 */
...
/**
 * Validates and optionally hashes a password.
 *
 * @param {string} pw - Password value.
 * @param {Object} rules - Password validation rules.
 * @param {Object} obj - Parent object being validated.
 * @param {string} path - Validation path.
 * @param {Array<Object>} errors - Error accumulator.
 * @param {string} key - Object key to replace if hashing.
 *
